...
export function AdminPage() {
  ...
  return (
    <AdminShell
      ...
      onLogout={logout}
      clinicaId={clinic.id}
      noPadding={activeModule === "Atendimento"}
    ...
    >
      ...
      {activeModule === "Atendimento" ? <WhatsAppPanel clinicId={clinic.id} onNavigateToAppointments={() => changeModule("Agendamentos")} /> : (
        <div className="space-y-5">
          ...
          {activeModule === "Profissionais" ? <ProfessionalsPanel clinicId={clinic.id} professionals={data.professionals} onSave={data.saveProfessional} onDelete={data.deleteProfessional} onCreateAccess={data.createStaffUser} /> : null}
          ...
          {activeModule === "Configurações" ? <SettingsPanel clinicId={clinic.id} /> : null}
        </div>
      )}
    </AdminShell>
  );
